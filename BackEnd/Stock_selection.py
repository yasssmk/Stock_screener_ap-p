...
def selection_by_fundamentals(csv_file_path, num_companies_to_select):
    try:
        ...
        Sending_Email.job_done_email("Selection by Fundamentals", error_log_path)

        return final_selection
    except Exception as e:
        Errors_logging.functions_error_log("selection_by_fundamentals", e, Errors_logging.log_name_rundb, symbol=symbol)
        error_log_path = './stocks_data_csv/errors_logs/Create_update_selection'
        Sending_Email.db_error_email(e, "selection_by_fundamentals", error_log_path)
