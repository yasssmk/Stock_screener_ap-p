...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ysamk\Desktop\Stock_screener_project\Python Code\Create and Update db\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ysamk\Desktop\Stock_screener_project\Python Code\Create and Update db\venv\Scripts\deactivate.nu'
